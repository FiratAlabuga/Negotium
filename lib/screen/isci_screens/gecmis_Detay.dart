...
class HistoryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String time = DateFormat.jm().format(job.data['beginTime'].toDate()) +
        " - " +
        DateFormat.jm().format(job.data['endTime'].toDate());
    return new Scaffold(
      body: new Container(
    ...
    return new Container(
      child: Image(
        image: new NetworkImage(
            "https://source.unsplash.com/featured/?" + job['name']),
        fit: BoxFit.cover,
        height: 150.0,
      ),
          ...
          new Container(
            ...
            child: new Column(
              ...
              children: <Widget>[
                ...
                Container(
                  child: Column(
                      children: <Widget>[Text(job.data['requirements'])],
                      mainAxisAlignment: MainAxisAlignment.start,
                      crossAxisAlignment: CrossAxisAlignment.start),
                  width: MediaQuery.of(context).size.width,
                  margin: EdgeInsets.fromLTRB(
