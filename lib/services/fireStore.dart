...
class FirestoreService {
  ...
  Future addListing(Map listing) async {
    ...
    DocumentSnapshot listingsSnapshot =
  ...
  Future selectCandidate(DocumentReference listingReference,
  ...
  Future updateUserData(
      String fname, String lname, String background, String bio) async {
  ...
  Future registerBasicInformation(
      String fname, String lname, bool employer) async {
  ...
  Future registerAddress(String street, String apartment, String city,
      String province, String postal) async {
    return await userCollection.document(uid).updateData({
      'street': street,
      'apartment': apartment,
      'city': city,
