                          ...
                          children: <Widget>[
                            Row(
                              children: <Widget>[
                                ...
                                Text("Ücret: ${widget.salary} /saat"),
                              ],
                            ),
                            Text(
                                "Paylaşım: ${months[widget.postDate.month]}, ${widget.postDate.day}")
                          ],
                        ),
                      ),
                    ],
                            ...
                            child: Column(
                              ...
                              children: applicants
                                  .map((applicant) => ListTile(
                                        ...
                                        subtitle: Text(
                                            'Nereden: ${applicant["city"]}, ${applicant["province"]}'),
                                        trailing: RaisedButton(
                                          color: Theme.of(context).accentColor,
                                          onPressed: () {
                                            FirestoreService(
                                                    uid: Provider.of<Kullanici>(
                                                            context,
                                                            listen: false)
                                                        .uid)
                                                .selectCandidate(
